...
public class CDKLaunchConfigurationDialog extends TitleAreaDialog {
	...
	private static final Logger log = Logger.getLogger(CDKLaunchConfigurationDialog.class);
	...
	public void cancel() {
		log.info("Pressing cancel button...");
		new CancelButton().click();
	}
	
	public void apply() {
		log.info("Pressing apply button...");
	...
	public void revert() {
		log.info("Pressing revert button...");
	...
	public void setArguments(String arguments) {
		...
		log.info("Replacing launch config arguments \"" + actual + "\" with \"" + arguments + "\"");

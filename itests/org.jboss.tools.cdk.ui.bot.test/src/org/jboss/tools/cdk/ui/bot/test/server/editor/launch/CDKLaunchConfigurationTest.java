...
import org.jboss.tools.cdk.ui.bot.test.server.exception.CustomAssertionErrorJBIDE25350;
...
public class CDKLaunchConfigurationTest extends CDKServerEditorAbstractTest {
	...
	@Test(expected=CustomAssertionErrorJBIDE25350.class)
	public void testServerNamePropagationIntoLaunchConfig() {
		...
		try {
			...
			throw new CustomAssertionErrorJBIDE25350();
		}
	}

...
public class CDKLaunchController extends AbstractSubsystemController implements ILaunchServerController, IExternalLaunchConstants {
	...
	public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor)
		...
		if( credType == CDKServer.CREDENTIAL_OPTION_PROMPT ) {
			launchViaTerminal(configuration, mode, launch, monitor);
		} else {
			launchViaExternalTools(credType, configuration, mode, launch, monitor);
		}
	}
